...
class hubspotStream(RESTStream):
    ...
    def _request(
        ...
        self.logger.info(f"Requesting {prepared_request.url}")
...
class hubspotStreamSchema(hubspotStream):
    ...
    def get_next_page_token(
        ...
        self.logger.info(f"Response JSON: has-more: {response_json.get('has-more')}, offset: {response_json.get('offset')}, vid-offset: {response_json.get('vid-offset')}")
